 ...
 */
const string kYourName = "Russell";

/* Change this constant to the path out of your labyrinth. */
const string kPathOutOfNormalMaze = "SSENSESWWEENENNWW";
/**
